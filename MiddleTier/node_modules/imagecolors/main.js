...
module.exports = {
    ...
    extractAllColors: function(image, callback){
        ...
        var command = 'histogram:info';    
        // extract histogram
        image.out('-format').out('%c').stream(command,function(err, stdout, stderr){
    ...
    /**
    * CUSTOM FUNCTION TO SORT COLORS BY PERCENTAGE
    *
    * @param {Array} colors
    * @return
    */
    sortColorsByPercentage: function (colors) {
    ...
    extractProminentColors: function(path, callback){
        ...
        this.convertPathToImage(path, function(err, image){
            ...
            if (err){
                ...
                // reduce image colors.colorspace('sRGB')
                ...
                delegate.extractAllColors(image, function(err, colors){
                    ...
                    if (err){
                        ...
                        delegate.assignColorFamilies(colors, function(colors){
                            ...
                            delegate.sortColorsByPercentage(colors);
