        ...
        for(ColorEntry c : ce) {
            ...
            switch (c.Color) {
                case brown:     //anticipation interest,..this will mean faces?? so maybe not count as much
                    cpe[i] = new ColorParamEntry(1.1, Accent.Staccato, .10, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case pink: //digust, boredom
                    cpe[i] = new ColorParamEntry( .75, Accent.Tenuto, .75, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case red:   //rage, anger
                    cpe[i] = new ColorParamEntry(2, Accent.Accent, .75, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case orange:    //surprise, anticipation
                    cpe[i] = new ColorParamEntry(1.25,Accent.Staccatissimo, .5, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case green: //fear
                    cpe[i] = new ColorParamEntry(1.25, Accent.Staccato, .25, false);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case yellow:    //surprise, joy
                    cpe[i] = new ColorParamEntry( 1.5, Accent.Staccatissimo, .75, true );
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case purple:    //disgust, loathing
                    cpe[i] = new ColorParamEntry( .75, Accent.Tenuto, .5, false );
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case blue: //Same as sad
                    cpe[i] = new ColorParamEntry(.5, Accent.Tenuto, .75, false );
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case light:     //weak emotion
                    cpe[i] = new ColorParamEntry(1.25, Accent.Unaccented, 0, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case neutral:   //no effect
                    cpe[i] = new ColorParamEntry(1, Accent.Unaccented, 0, true);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
                case dark:  //strong emotions
                    cpe[i] = new ColorParamEntry(1.5, Accent.Accent, .5, false);
                    cpe[i].overallWeight = c.Percent/100;
                    break;
            }
            i++;
